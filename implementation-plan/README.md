...
| Phase                                        | File                                                                   | Status          |
| -------------------------------------------- | ---------------------------------------------------------------------- | --------------- |
| 1 — VirtualScroller scroll-space compression | [phase-1-scroll-compression.md](./phase-1-scroll-compression.md)       | [ ] not started |
| 2 — Worker serial queue + real cancellation  | [phase-2-worker-cancellation.md](./phase-2-worker-cancellation.md)     | [ ] not started |
| 3 — TableBody fetch-pipeline rewrite         | [phase-3-fetch-pipeline.md](./phase-3-fetch-pipeline.md)               | [ ] not started |
