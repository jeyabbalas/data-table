...
| `LOAD_PARSE_FAILED`                                                                                       | `LoadError`             | CSV/JSON/Parquet parse failed. Reported for any loader failure that carries no more specific code.                                                                                                                                      | Inspect the offending row; most commonly a bad timestamp format.                                                                                                                                                 |
