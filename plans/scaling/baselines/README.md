...
| Generate (ms)               |                  14414 |
| Load (ms)                   |                   8336 |
| └ worker stage (ms)         |                 8334.4 |
| └ first paint (ms)          |                 8334.7 |
| └ viz ready (ms)            |                 8334.5 |
| Queries sent                |                      4 |
| Cache hits                  |                      0 |
| DOM nodes                   |                  51052 |
...
| Generate (ms)               |                  21063 |
| Load (ms)                   |                  11192 |
| └ worker stage (ms)         |                11191.7 |
| └ first paint (ms)          |                11191.9 |
| └ viz ready (ms)            |                11191.8 |
| Queries sent                |                      4 |
| Cache hits                  |                      0 |
| DOM nodes                   |                   1072 |
| Canvases                    |                      0 |
| Live ResizeObservers        |                      1 |
| Live MutationObservers      |                      1 |
| sortColumns subscribers     |                     25 |
| JS heap (MB)                |                  347.1 |
| One sort (ms)               |                  124.8 |
| One filter (ms)             |                   38.9 |
| Scroll storm frame p95 (ms) |                    9.3 |
