...
- [`derivedChange` event](../../docs/api-reference.md#event-catalog)
...
3. The `derivedChange` event fires after each addition — the status bar lists the current derived columns.
